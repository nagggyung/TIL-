...
### 문25) 원형 큐 디자인(리트코드 622. Design Circular Queue)

### 원형 큐(Circular Queue):
- '원형 큐'는 FIFO 구조를 지닌다는 점에서 기존의 큐와 동일
- 마지막 위치가 시작 위치와 연결되는 구조 
- 링 버퍼(=원형 큐)


![2021-10-08](https://user-images.githubusercontent.com/74478432/136503060-a97884c9-51b3-404a-a8a5-dea6963c42ee.png)

- enQueue()를 하게 되면 rear 포인터가 앞으로 이동
